...
const objLoader = new OBJLoader();
  // Load the satellite OBJ model
  objLoader.load(
    'src/uploads_files_2942995_Sattelight.obj',
    (object) => {
      // Adjust position, scale, or any other properties
...
const satelliteMaterial = new THREE.MeshPhongMaterial({ color: 0x888888 });
// sattelites
const satellites = [];
